...
class Mpengumuman extends CI_Model{
	...
	public function get($id){
		$query=$this->db->get_where($this->table,array('id_pengumuman'=>$id));
	...
	public function update(array $newPengumuman,$id){
    	$this->db->update($this->table,$newPengumuman,array('id_pengumuman'=>$id));
    	return true;
	}

	public function delete($id)
	{
		$this->db->delete($this->table,array('id_pengumuman'=>$id));			
		return true;		
	}
