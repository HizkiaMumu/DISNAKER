<?php echo validation_errors(); ?>
    <div id="global">
      <div class="container-fluid cm-container-white">
        <h1>
            INPUT DATA
            <small><i class="ace-icon fa fa-angle-double-right"></i>KOPERASI</small>
        </h1>

        <hr>
		<div class="col-sm-8">
			<br>
			<?=form_open(base_url('koperasi/add'),'class="form-horizontal"')?>
			  <div class="form-group">
			    <label class="col-sm-3 control-label">Nama Koperasi</label>
			    <div class="col-sm-9">
			      <input type="text" class="form-control" name="nama_koperasi" value="" >
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-9">
			      <input type="text" class="form-control" name="no_badan_hukum" value="" >
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			      <input type="text" class="form-control tanggal" name="tgl_badan_hukum" value="">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-9">
			      <input type="text" class="form-control" name="pengesahan_oleh">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-3">
			      <input type="text" class="form-control" name="tempat_kedudukan">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" name="pembuat_akta">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input type="text" class="form-control" name="no_PAD" value="">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			      <input type="text" class="form-control tanggal" name="tgl_PAD" value="">
			    </div>
			  </div>
