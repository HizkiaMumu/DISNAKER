...
<html lang="en">
  <head>
	...
	<body>
		...
		<div class="col-md-4"></div><!-- // END : column //  -->
		<div class="col-md-4 align-c">
			<br>
			<div class="bg-dark pd-mini rd-6 mr-b-micro" >
				<h3 class="title txt-white f-1" data-rgen-sm="small">Pencari Kerja</h3>
				<p class="txt-white op-08" data-rgen-sm="small mr-0">Login untuk pencari kerja. <br>Dengan melengkapi data anda disini maka akan memudahkan anda dalam peoses penerbitan kartu AK/1 (kartu kuning) maupun dalam proses melamar pekerjaan pada lowongan pekerjaan yang di publish Disnaker Kota Balikpapan.</p>
			</div>

			<div class="pos-rel -mr-t-40 mr-b-micro">
				<span class="sq60 iconbox rd txt-white fs20 bg-default bdr-5 shadow-mini bdr-white">
					<a href="<?=base_url();?>"><i class="fa fa-arrow-down"></i></a>
				</span>
			</div>


			<div class="pd-mini bg-white shadow-medium rd-6 bdr-3 bdr-default" data-rgen-sm="pd-30">
				<h3 class="title small">Login Pencaker</h3>
				<form action="form-data/notify-me.php" class="form-widget" data-formtype="newsletter">
					<div class="field-wrp">
						<div class="form-group">
							<input class="form-control" data-label="Email" required data-msg="Please enter email." type="email" name="email" placeholder="Masukkan Email">
						</div>
						<div class="form-group">
							<input class="form-control" required data-label="Phone" data-msg="Please phone number." type="text" name="phone" placeholder="Masukkan Password">
						</div>									
					</div>
					<button type="submit" data-loading-text="Pleae wait.." class="btn btn-dark hov-btn-default solid">Login</button>
					<a href="registrasi" class="btn btn-default hov-btn-dark solid">Registrasi</a>
				</form><!-- / form -->
			</div>
		</div><!-- // END : column //  -->
