	...
	<body>
		...
		<div class="col-md-4 align-c">
			...
			<div class="bg-dark pd-mini rd-6 mr-b-micro" >
				<h3 class="title txt-white f-1" data-rgen-sm="small">BKK</h3>
				<p class="txt-white op-08" data-rgen-sm="small mr-0">Bursa Kerja Khusus</p>
			</div>
			...
			<div class="pd-mini bg-white shadow-medium rd-6 bdr-3 bdr-default" data-rgen-sm="pd-30">
				<h3 class="title small">Login BKK</h3>
